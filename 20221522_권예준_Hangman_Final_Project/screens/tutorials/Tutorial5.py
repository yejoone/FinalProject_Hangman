...
from screens.tutorials.Tutorial6 import Tutorial6
...
class Tutorial5(Game):
    ...
    def draw(self):
        ...
        utils.drawText(Vector2(50, 400), "2.If your guess is incorrect", (233, 23, 23), utils.font16)
        utils.drawText(Vector2(60, 420), "draw a part of hangman", (233, 23, 23), utils.font16)
        ...
        for button in self.buttons:
            ...
            if button.clicked:
                if button.id == 0:
                    ...
                    break
                if button.id == 1:
                    utils.currentScreen = Tutorial6()
                    break
                if button.id == 2:
                        from screens.tutorials.Tutorial4 import Tutorial4
                        utils.currentScreen = Tutorial4()
                        break
